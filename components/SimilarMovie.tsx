...
import { HomeProp, MovieProp, PersonProp } from "../types/stackParams";

// dimansional width and height
const { width, height } = Dimensions.get("window")

const SimilarMovie = ({navigation}: MovieProp) => {

  const { similarMovie } = useContext(DataProvider)
  ...
  return (
    <View className="mb-8 space-y-4">
      <View className="mx-4 flex-row justify-between items-center">
        <Text className="text-white text-xl">Similar Movies</Text>
        {/* <TouchableOpacity>
